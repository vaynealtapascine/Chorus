...
- [~] M14.4 Owner decisions: D0–D4, D6, D7, D12, D14, D15 settled 2026-09-26 and applied (name PluralSpec, PluralPort superset, UTF-16 default offsets, CC BY-NC-SA 4.0); D8 (visibility classes with permission grants), D9 (age) and D14 (schema CC BY 4.0, text CC BY-NC-SA 4.0) settled later the same day; D5 (subsystem internal fronts, composite members — collectives, blends, fusions — blend ids, partial decoherence, fronting on behalf of a subsystem; in the schema after the owner's answers) and D11 (history events) await the owner's review
