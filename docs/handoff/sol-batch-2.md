...
- **Compiled/unit-tested only:** The phone was off adb. Later, reply to a disposable followed post, check the selected audience and that the author reads it, then revoke the follow and confirm a new reply is refused. Android People still has no on-demand reply-thread reader for a foreign parent; lists/feeds and remaining profile details follow.
