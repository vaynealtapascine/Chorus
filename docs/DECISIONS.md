...
| Android sync libs | OkHttp 4.12.0, kotlinx-coroutines-android 1.9.0 | 2026-09-23 | Foreground WebSocket sync and the serial local-store worker; Room, SQLCipher and WorkManager are still pending M4.2. |
