...
fn src() -> impl Strategy<Value = String> {
    let atoms = prop_oneof![
        Just("*"), Just("**"), Just("_"), Just("__"), Just("~~"), Just("||"), Just("`"), Just("```"),
        Just("["), Just("]"), Just("("), Just(")"), Just("](https://a.b)"), Just("> "), Just(">> "),
        Just("\n"), Just(" "), Just("\\"), Just("\\&"), Just("@kai"), Just("@x"), Just(":wave:"), Just(":"),
        Just("https://x.y/z"), Just("a"), Just("bc"), Just("🌌"), Just("é"), Just("snake_case"), Just("rust\n"),
    ];
